  ...
  return (
    <PageShellContext.Provider value={ctxValue}>
      <div className="relative min-h-dvh overflow-hidden">
        ...
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 bg-sky-600 text-white px-3 py-1 rounded"
        >
          Skip to content
        </a>
        ...
        >
          ...
          {/* Main */}
          <main id="main" tabIndex={-1} className="p-4" style={mainBottomPad}>
