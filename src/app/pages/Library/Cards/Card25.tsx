  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 gap-0">
        <img
          src={`https://picsum.photos/id/${leftId}/900/900`}
          alt=""
          className="h-44 w-full object-cover"
        />
        <img
          src={`https://picsum.photos/id/${rightTopId}/900/900`}
          alt=""
          className="h-44 w-full object-cover"
        />
      </div>
      <div className="p-5">
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <button
            className="rounded-lg bg-neutral-900 px-4 py-2 text-sm text-white hover:bg-black focus:outline-none focus:ring-4 focus:ring-neutral-300"
            onClick={() => alert("Add bundle")}
            type="button"
          >
            Add bundle
          </button>
